            ...
            <div class="row gy-4">
                <div class="col-6 col-lg-4 col-md-6 footer-about">
                    <a href="index.html" class="logo d-flex align-items-center">
                        <span class="sitename">Playzyy</span>
                    </a>
                    <div class="footer-contact pt-3">
                        <p>Paul Jason klein</p>
                        <p>Indonesia</p>
                        <p class="mt-3"><strong>Phone:</strong> <span>20202324</span></p>
                        <p><strong>Email:</strong> <span>Lany@example.com</span></p>
                    </div>
